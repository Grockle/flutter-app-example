...
class RoutineCard extends StatefulWidget {
  ...
  final double height;
  final int icon;
  const RoutineCard(this.schedule, this.icon,this.height, this.width);
...
class _RoutineCardState extends State<RoutineCard> {
    List<String> icons = ['assets/daily_routine.json', 'assets/coffee_routine.json', 'assets/yoga_routine.json', 'assets/read_routine.json'];
    @override
