...
class ActivityCard extends StatefulWidget {
  ...
  final double height;
  final int icon;
  const ActivityCard(this.schedule, this.icon,this.height, this.width);
...
class _ActivityCardState extends State<ActivityCard> {
  List<String> icons = ['assets/sport_activity.json', 'assets/meeting_activity.json', 'assets/travel_activity.json'];
  @override
